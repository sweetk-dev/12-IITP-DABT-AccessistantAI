...
- 레포 태그: **v1.42.0** (장소 해석 카카오 로컬 폴백 — 기관명·상호·도로명주소) / v1.41.0 (미답변 질의 2층 구분 · 장소 해석 실패 판정 · 이동 방식 라벨은 실제 구간 기준) / v1.40.0 (상담 음성 에코 억제 · 답변 숫자 표기 정규화) / v1.39.0 (실시간 저상버스 도착정보 · 역 편의시설 설비 단위 안내)
- 백엔드 내부: v1.2
